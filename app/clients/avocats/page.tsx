...
import { Scale, CheckCircle, Target, TrendingUp } from "lucide-react";
import Link from "next/link";
import { ArrowRight } from "lucide-react";

export default function ClientsAvocatsPage() {
  return (
    <div>
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 py-20 w-full max-w-7xl mx-auto">
          <Scale className="mx-auto mb-8 text-gold" size={64} />
          <h1 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold text-text-primary mb-8 uppercase tracking-wide leading-tight">
            Comment vendre aux <span className="text-gold">Cabinets d&apos;Avocats</span>
          </h1>
          <p className="text-xl md:text-2xl lg:text-3xl text-text-secondary max-w-4xl mx-auto mb-12 leading-relaxed">
            Tout ce dont tu as besoin pour présenter Nexus Circle aux cabinets d&apos;avocats
          </p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {/* Bénéfices pour les cabinets d'avocats */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-text-primary mb-8 text-center uppercase tracking-wide">Ce que le cabinet d&apos;avocats gagne</h2>
          <p className="text-lg text-text-secondary mb-8 text-center max-w-3xl mx-auto">
            Présente ces bénéfices aux cabinets d&apos;avocats pour montrer la valeur d&apos;un site premium
          </p>
            ...
            {[
              {
                ...
                description: "Un site structurant qui reflète la qualité de votre expertise et inspire confiance aux prospects avant même qu'ils vous contactent."
              },
              {
                icon: <CheckCircle className="text-gold" size={32} />,
                title: "Qualification des demandes",
                description: "Présentez clairement vos domaines d'intervention pour filtrer les demandes non pertinentes et attirer les clients qui correspondent à vos expertises."
              },
              {
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-text-primary mb-8 text-center uppercase tracking-wide">Ce que comprend le site pour cabinets d&apos;avocats</h2>
          <p className="text-lg text-text-secondary mb-8 text-center max-w-3xl mx-auto">
        ...
        <section className="mb-12 text-center">
          <div className="card border-gold/30">
            ...
            <p className="text-text-secondary mb-6 max-w-2xl mx-auto">
              Maintenant que tu connais les arguments pour les cabinets d&apos;avocats, découvre comment présenter Nexus Circle et décrocher des rendez-vous.
            </p>
